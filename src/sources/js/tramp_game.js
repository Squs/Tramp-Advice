...
function tramp() {
    ...
    div.textContent = tramp_name;

    let a = document.createElement('a');
    a.href = tramp_game_url[random_number];
    a.textContent = 'wikiはこちら。';

    let tramp_information = document.getElementById('tramp');

    tramp_information.appendChild(div);
    tramp_information.appendChild(a);
}
